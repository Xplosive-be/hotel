...
<div class="container col-xxl-8 px-4 py-5">
  <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-8 col-lg-6">
      <img src="ressources/images/83071739.jpg" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
    </div>
    <div class="col-lg-6">
...
<div class="container py-5"> 
    ...
    <div class="row text-center">
      <div class="col-xl-3 col-sm-6 mb-5 sizeTeam">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="ressources/images/teams/Elon_Musk_Royal_Society.jpg" alt="Elone Muska" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Elone Muska</h5><span class="small text-uppercase text-muted">Directeur</span>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 mb-5 sizeTeam">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="ressources/images/teams/receptionniste.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Samuel Hardy</h5><span class="small text-uppercase text-muted">Responsable Accueil</span>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 mb-5 sizeTeam">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="ressources/images/teams/menage.jpg" alt="Femme de ménage" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
          <h5 class="mb-0">Tom Sunderland</h5><span class="small text-uppercase text-muted">Réponsable service ménage</span>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6 mb-5 sizeTeam">
        <div class="bg-white rounded shadow-sm py-5 px-4"><img src="ressources/images/teams/AVT_Philippe-Etchebest_9559.jpg" alt="Philippe Etchebest" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
